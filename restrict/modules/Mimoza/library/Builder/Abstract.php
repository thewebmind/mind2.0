...
abstract class Mimoza_Builder_Abstract
{
     ...
     * @param Mimoza_Project $project Projeto Mimoza
     */
    public function __construct(Mimoza_Project_Abstract $project)
    {
     ...
     * @param Mimoza_Project_Abstract $project Projeto Informado pelo Webmind
     * @return Mimoza_Builder_Abstract Próprio Objeto para Encadeamento
     */
    ...
    /**
     * Informa o Projeto do Mimoza Configurado
     * @return Mimoza_Project_Abstract Projeto do Mimoza
     */
    ...
    protected function _run($script)
    {
        ...
        if (!is_file($filename)) {
            Mimoza_Loader::loadClass('Mimoza_Builder_Exception');
